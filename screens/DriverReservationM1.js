...
export default function DriverReservationM1({...props}) {
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await fetch('http://192.168.42.157:3001/DriverCin');
  ...
  const latidude = props.route.params.latitude;
